-- Harden remote clear helper:
-- 1) require authenticated owner
-- 2) clear change_log after mutating deletes so trigger-generated rows are removed
...
begin
  ...
  if not exists (
    ...
    raise exception 'Only company owner can clear sync data';
  end if;
  ...
  -- MUST run last so trigger-generated log rows are removed too.
